...
docker run -itd \
    ...
    -e FABRIC_CA_SERVER_CA_KEYFILE=/etc/hyperledger/fabric-ca-server-config/6b8db552d1974a84a7840e62a0cd0a145cf2bc1412e301e2a8e3899b7834565b_sk \
    -e FABRIC_CA_SERVER_TLS_ENABLED=true \
    -e FABRIC_CA_SERVER_TLS_CERTFILE=/etc/hyperledger/fabric-ca-server-config/ca.org1.kt.com-cert.pem \
    -e FABRIC_CA_SERVER_TLS_KEYFILE=/etc/hyperledger/fabric-ca-server-config/6b8db552d1974a84a7840e62a0cd0a145cf2bc1412e301e2a8e3899b7834565b_sk \
...
docker run -itd \
    ...
    -e FABRIC_CA_SERVER_CA_KEYFILE=/etc/hyperledger/fabric-ca-server-config/832de0eeffe5ce0c3ba335f56ba9d4ee9288bcd1034f2e5030082f53faf8a764_sk \
    -e FABRIC_CA_SERVER_TLS_ENABLED=true \
    -e FABRIC_CA_SERVER_TLS_CERTFILE=/etc/hyperledger/fabric-ca-server-config/ca.org2.kt.com-cert.pem \
    -e FABRIC_CA_SERVER_TLS_KEYFILE=/etc/hyperledger/fabric-ca-server-config/832de0eeffe5ce0c3ba335f56ba9d4ee9288bcd1034f2e5030082f53faf8a764_sk \
